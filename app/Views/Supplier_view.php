                                        ...
                                        <tr>
                                            <td>
                                                <div class="hidden-sm hidden-xs action-buttons">
                                                    ...
                                                    <a class="red" href="#modalDeleteDiningArea<?php echo $value["supplierId"]; ?>" data-toggle="modal">
                                            ...
                                            <td><?php echo $value['supplierTypeName']; ?></td>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <label>¿Estás seguro de que quieres eliminar este proveedor?</label>
                                        </div>
                                    </div>
                                    <div class="space"></div>
                                    <div class="row">
