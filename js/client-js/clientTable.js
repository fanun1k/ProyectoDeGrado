    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            jQuery(grid_selector).jqGrid({
                ...
                },  {name: 'clientId',index: 'clientId', width: 60,editable: false,sorttype: "int"},
                    {name: 'clientCode',index: 'clientCode',width: 70,editable: true,},
                    {name: 'clientName',index: 'clientName',width: 90,editable: true,},
                    {name: 'clientLastName1',index: 'clientLastName1',width: 150,editable: true,},
